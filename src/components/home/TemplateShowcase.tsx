        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div className="space-y-3">
            ...
            <p className="max-w-2xl text-sm leading-7 text-on-surface-variant md:text-base">
              The template gallery stays dynamic and connected to the existing registry. All {AVAILABLE_TEMPLATES.length} templates,
              including PaperTrail, still follow the same real create-draft or guest redirect flow.
            </p>
          </div>
