const steps = [
  {
    ...
    body: "Choose one of the 8 finished portfolio starters already connected to the editor.",
  },
  {
    title: "Edit directly",
...
const features = [
  ...
  },
  {
    ...
    body: "All 8 free starters use the same real editor, save flow, and export path.",
  },
];
          ...
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            ...
            <article className="flex rounded-xl items-center justify-center border border-secondary bg-secondary/5 p-5 text-center">
              <div className="space-y-2">
                <p className="text-4xl font-semibold uppercase tracking-[-0.05em] text-secondary">8</p>
