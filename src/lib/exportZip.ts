...
type ExportTemplateId = "simple-starter" | "dark-starter" | "profile-card" | "light-vcard";
...
export async function downloadPortfolioZip(portfolio: PortfolioData, templateId: string) {
  ...
  const resolvedTemplateId = (
    templateId === "dark-starter" || templateId === "profile-card" || templateId === "light-vcard" ? templateId : "simple-starter"
  ) as ExportTemplateId;
