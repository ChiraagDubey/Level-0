...
type ExportTemplateId = "simple-starter" | "dark-starter" | "profile-card";
...
export async function downloadPortfolioZip(portfolio: PortfolioData, templateId: string) {
  const zip = new JSZip();
  const resolvedTemplateId = (templateId === "dark-starter" || templateId === "profile-card" ? templateId : "simple-starter") as ExportTemplateId;
